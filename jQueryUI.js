...
$(function(){
    ...
    function updateUIWithProductPreview(product) {
        // Assuming you have an HTML element with the id 'productPreview' to display the product preview
        const $productPreviewElement = $('#productPreview');
console.log("preview",product)
        // Create HTML content to display the product preview
        ...
        // Use the .prepend() method to add the product preview at the beginning of the 'productPreview' element
